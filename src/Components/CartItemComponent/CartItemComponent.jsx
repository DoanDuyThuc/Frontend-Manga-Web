    ...
    return (
        <div className='CartItemComponent'>
            <div style={{ margin: marginZero ? 0 : '0 10px' }} className='CartItemComponent__CartItemAvartar'>
                <NavLink to='/guest/truyen-tranh/one-piece'>
                    <img loading='lazy' src='https://ddntcthcd.com/nettruyen/thumb/ta-la-nhan-vat-phan-dien-dai-thieu-gia.jpg' alt='Win Over The Dragon Emperor This Time Around, Noble Girl!' />
                </NavLink>
            ...
            <div className='CartItemComponent__CartItemInfo'>
                <div className='CartItemComponent__CartItemInfo__name'>
                    <h3>
                        <NavLink to='/guest/truyen-tranh/one-piece'>Win Over The Dragon Emperor This Time Around, Noble</NavLink>
                    </h3>
                </div>

                <div className='CartItemComponent__CartItemInfo__chapter'>
                    <NavLink to='/guest/truyen-tranh/one-piece'>Chương 125</NavLink>
                </div>
            </div>
        </div>
    )
