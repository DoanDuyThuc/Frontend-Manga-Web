...
export const UpdateChuong = () => {
    ...
    //query
    const { data } = useQuery({
        queryKey: ['GetChuong', { id, ChuongId }],
        queryFn: async ({ queryKey }) => {
            const [, { id, ChuongId }] = queryKey;
            const response = await GetChuongTruyenService({ id, ChuongId });
            return response;
        },
        enabled: !!id,
